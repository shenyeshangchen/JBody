...
-- ----------------------------
-- Table structure for meetbody_admin
-- ----------------------------
DROP TABLE IF EXISTS `meetbody_admin`;
CREATE TABLE `meetbody_admin`  (
...
INSERT INTO `meetbody_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 0, 0, 0);

-- ----------------------------
-- Table structure for meetbody_fav
-- ----------------------------
DROP TABLE IF EXISTS `meetbody_fav`;
CREATE TABLE `meetbody_fav`  (
...
-- ----------------------------
-- Table structure for meetbody_meet
-- ----------------------------
DROP TABLE IF EXISTS `meetbody_meet`;
CREATE TABLE `meetbody_meet`  (
...
-- ----------------------------
-- Table structure for meetbody_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meetbody_meet_join`;
CREATE TABLE `meetbody_meet_join`  (
...
-- ----------------------------
-- Table structure for meetbody_news
-- ----------------------------
DROP TABLE IF EXISTS `meetbody_news`;
CREATE TABLE `meetbody_news`  (
...
-- ----------------------------
-- Table structure for meetbody_setup
-- ----------------------------
DROP TABLE IF EXISTS `meetbody_setup`;
CREATE TABLE `meetbody_setup`  (
...
-- ----------------------------
-- Table structure for meetbody_user
-- ----------------------------
DROP TABLE IF EXISTS `meetbody_user`;
CREATE TABLE `meetbody_user`  (
