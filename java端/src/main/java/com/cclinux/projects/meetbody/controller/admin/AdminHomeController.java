...
import com.cclinux.projects.meetbody.service.admin.AdminHomeService;
import com.cclinux.projects.meetbody.service.cust.PublicService;
...
@RestController("MeetBodyAdminHomeController")
public class AdminHomeController extends com.cclinux.projects.meetbody.controller.admin.BaseMyAdminController {

    @Resource(name = "MeetBodyAdminHomeService")
    private AdminHomeService adminHomeService;

    @Resource(name = "MeetBodyPublicService")
