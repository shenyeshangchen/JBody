package com.cclinux.projects.meetbody.service.admin;
...
import com.cclinux.projects.meetbody.comm.ProjectConfig;
...
import com.cclinux.projects.meetbody.service.cust.MeetService;
...
@Service("MeetBodyAdminMeetService")
public class AdminMeetService extends BaseMyAdminService {
    ...
    @Resource(name = "MeetBodyMeetService")
    ...
    public long insertMeet(MeetModel meet) {
        appError("{健身房}该功能暂不开放，如有需要请加作者微信：cclinux0730");
